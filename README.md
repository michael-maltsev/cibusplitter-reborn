...
## Installation
To install the extension please use the Chrome Web Store: \
https://chrome.google.com/webstore/detail/cibusplitter/pilnigkcdmgdadikndefiainijkegojn
\
...
## Features
1. Shipping price is divided between participant according to each participant's
   cost.
2. List of friends can be manually added (to convert between Wolt and Cibus
   display names).
